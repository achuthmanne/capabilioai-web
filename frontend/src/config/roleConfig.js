...
// ─── Role Registry ────────────────────────────────────────────────────────────
// Each entry: { id, label, slug, stream, arenaKey, color,
//              aliases[],          ← alternate job titles (MCU Developer, SDE-2, etc.)
//              keywords[],         ← search tokens (matched in typeahead)
//              auraSkills[],       ← skills tracked on Aura radar
//              assessmentSkills[], ← MCQ generation topics
//              streamCategories[], ← engineering challenge bank filter keys
//              launchpadTags[],    ← job search keywords
//              pulseTopics[],      ← feed topic filters
//              interviewFocus[], } ← AI interview focus areas
...
const ROLE_REGISTRY = [
...

  {
    ...
    color: "#F59E0B",
    aliases: ["react js developer","angular js developer","vue js developer","front-end engineer","ui/ux developer","web ui engineer","javascript developer"],
    ...
    auraSkills: ["React","JavaScript","TypeScript","CSS/Tailwind","Next.js","State Management","REST APIs","Testing (Jest/RTL)","Performance Optimization","Accessibility"],
...

  {
    ...
    arenaKey: "backend",
    color: "#10B981",
    aliases: ["node developer","java backend","python backend","spring developer","flask developer","fastapi developer","server engineer","rest api developer"],
    ...
    auraSkills: ["Node.js / Express","REST API Design","Database Design","Authentication & JWT","Caching (Redis)","Message Queues","Microservices","Docker","SQL / PostgreSQL","System Design","API Security"],
...

  {
    ...
    arenaKey: "fullstack",
    color: "#8B5CF6",
    aliases: ["mern developer","mean developer","react node developer","web application developer","full-stack engineer","mern stack"],
    keywords: ["full stack","fullstack","mern","mean","full-stack","react node","frontend backend"],
    auraSkills: ["React / Next.js","Node.js / Express","PostgreSQL / MongoDB","REST & GraphQL APIs","Authentication","Docker / CI-CD","TypeScript","System Design","Testing","Cloud Deployment","State Management","Database Design","Monitoring & Logging"],
...

  {
    ...
    arenaKey: "swe",
    color: "#6366F1",
    aliases: ["software development engineer","sde 1","sde 2","application engineer","java engineer","python engineer","c++ developer","golang developer","backend sde"],
    ...
    auraSkills: ["Data Structures & Algorithms","System Design","OOP Principles","Design Patterns","Concurrency","Databases","Testing","Version Control (Git)","API Design","Problem Solving"],
...

  {
    ...
    arenaKey: "data",
    color: "#D97706",
    aliases: ["sql analyst","reporting analyst","analytics specialist","business intelligence analyst","excel data analyst"],
    ...
    auraSkills: ["SQL (Advanced)","Python (Pandas/NumPy)","Power BI / Tableau","Excel / Spreadsheets","Statistical Analysis","Data Cleaning","Dashboard Design","KPI Definition","A/B Testing","Data Storytelling","ETL Concepts"],
...

  {
    ...
    color: "#059669",
    aliases: ["big data engineer","airflow developer","data infrastructure engineer","data platform engineer","lakehouse engineer","pyspark developer"],
    ...
    auraSkills: ["Apache Spark","Kafka / Streaming","dbt (Data Build Tool)","Airflow / Orchestration","SQL Warehousing","Python (PySpark)","Data Modeling","Cloud (AWS/GCP/Azure)","ETL Pipeline Design","Schema Design","Data Quality","Monitoring & SLAs","Data Warehousing (Snowflake/BigQuery)"],
...

  {
    ...
    arenaKey: "bi_analyst",
    color: "#8B5CF6",
    aliases: ["reporting specialist","dashboard developer","power bi specialist","data visualization analyst","looker developer","bi developer"],
    ...
    auraSkills: ["Power BI (DAX/Power Query)","Tableau","SQL for BI","Star Schema / Dimensional Modeling","KPI Design","ETL for Reporting","Data Storytelling","Executive Dashboards","Data Governance"],
...

  {
    ...
    arenaKey: "dba",
    color: "#06B6D4",
    aliases: ["sql server dba","database admin","oracle developer","postgres dba","mysql developer","db developer"],
    ...
    auraSkills: ["SQL (Expert)","Database Design & Normalization","Indexing & Query Optimization","Backup & Recovery","Replication & HA","PostgreSQL / MySQL / Oracle","Performance Tuning","Security & Access Control","Stored Procedures","Partitioning","Cloud Databases (RDS/Cloud SQL)"],
...

  {
    ...
    arenaKey: "cyber",
    color: "#EF4444",
    aliases: ["security analyst","infosec analyst","vapt engineer","pentester","bug bounty hunter","network security engineer","appsec engineer"],
    ...
    auraSkills: ["Network Security","OWASP Top 10","Penetration Testing","SIEM Tools","Threat Modeling","Vulnerability Assessment","Incident Response","Cryptography","Firewall & IDS/IPS","Cloud Security","Secure Coding","Compliance (ISO/NIST)","Zero Trust Architecture"],
...

  {
    ...
    arenaKey: "devops",
    color: "#F97316",
    aliases: ["ci/cd engineer","release engineer","build engineer","gitops engineer","cloud automation engineer","deployment engineer"],
    ...
    auraSkills: ["Docker & Kubernetes","CI/CD Pipelines (Jenkins/GitHub Actions)","Terraform / IaC","Linux Administration","Monitoring (Prometheus/Grafana)","Git & GitOps","Bash Scripting","Cloud Platforms","Ansible / Chef / Puppet","Log Management (ELK)","Security (DevSecOps)","Incident Management","Infrastructure Cost Optimization","Networking & Load Balancing"],
...

  {
    ...
    arenaKey: "sre",
    color: "#0EA5E9",
    aliases: ["production engineer","cloud reliability engineer","chaos engineer","on-call engineer","infrastructure reliability engineer"],
    keywords: ["sre","site reliability engineer","platform engineer","reliability engineer","production engineer","infrastructure sre"],
    auraSkills: ["SLI/SLO/SLA Design","Incident Management","Chaos Engineering","Kubernetes (Production)","Observability Stack","Capacity Planning","Toil Reduction","On-Call Engineering","Runbooks & Playbooks","Error Budgets","Distributed Systems","Post-Mortems","Load Testing & Performance Engineering"],
...

  {
    ...
    arenaKey: "aws",
    color: "#F59E0B",
    aliases: ["aws developer","aws architect","aws certified developer","cloud infrastructure engineer","cloud solutions architect","amazon cloud developer"],
    ...
    auraSkills: ["EC2 / VPC / IAM","S3 & Storage Services","Lambda & Serverless","RDS & DynamoDB","CloudFormation / CDK","EKS / ECS","CloudWatch & X-Ray","Route 53 & CloudFront","Security (KMS/Secrets Manager)","Cost Optimization","Well-Architected Framework","Migration Strategies","Networking (VPC Peering/Direct Connect)"],
...

  {
    ...
    arenaKey: "azure",
    color: "#0EA5E9",
    aliases: ["azure architect","microsoft azure developer","azure data engineer","azure administrator","cloud engineer microsoft"],
...

  {
    ...
    arenaKey: "soc",
    color: "#DC2626",
    aliases: ["siem analyst","splunk analyst","threat analyst","ioc analyst","dfir analyst","tier 1 security analyst"],
    ...
    auraSkills: ["SIEM (Splunk/QRadar)","Log Analysis","Threat Hunting","Malware Analysis","DFIR","Network Traffic Analysis","IOC/IOA Detection","Phishing Analysis","MITRE ATT&CK","Playbook Execution"],
...

  {
    ...
    arenaKey: "qa",
    color: "#7C3AED",
    aliases: ["software tester","test engineer","automation tester","qe engineer","test lead","manual tester","qa automation engineer"],
    ...
    auraSkills: ["Test Automation (Selenium/Playwright)","API Testing (Postman/RestAssured)","CI Integration","Test Strategy & Planning","BDD (Cucumber/Gherkin)","Performance Testing (JMeter)","Mobile Testing","SQL for QA","Bug Reporting","Risk-Based Testing","Accessibility Testing"],
...

  {
    ...
    arenaKey: "ba_product",
    color: "#D97706",
    aliases: ["business analyst it","product owner","requirements engineer","digital business analyst","it ba","product manager associate"],
    ...
    auraSkills: ["Requirements Gathering","User Story Writing","Process Mapping (BPMN)","Stakeholder Management","Agile / Scrum","SQL for Analysis","Wireframing (Figma/Balsamiq)","UAT Coordination","KPI Metrics","Data Analysis","Jira / Confluence"],
...

  {
    ...
    arenaKey: "medical",
    color: "#EC4899",
    aliases: ["medical billing specialist","clinical documentation specialist","aapc coder","ahima coder","health information coder"],
    ...
    auraSkills: ["ICD-10-CM/PCS Coding","CPT Procedure Coding","Medical Terminology","Anatomy & Physiology","HCPCS Level II","DRG Assignment","Medical Record Review","Payer Guidelines","Compliance (HIPAA)","EHR Systems"],
    ...
    streamCategories: ["Pharmacy", "Aptitude", "Logical"],
...

  {
    ...
    arenaKey: "embedded",
    color: "#84CC16",
    aliases: ["embedded c developer","mcu developer","stm32 developer","esp32 developer","embedded linux engineer","firmware developer","bare metal developer","microcontroller programmer"],
...

  {
    ...
    arenaKey: "vlsi",
    color: "#84CC16",
    aliases: ["chip design engineer","asic design engineer","rtl design engineer","fpga developer","dv engineer","physical design engineer","digital design engineer","verification engineer"],
    ...
    auraSkills: ["Digital Logic Design","Verilog / SystemVerilog","VHDL","RTL Design & Synthesis","Static Timing Analysis","Floorplanning & Placement","Clock Tree Synthesis","DRC / LVS / ERC","UVM Verification","ASIC Design Flow","FPGA Implementation"],
...

  {
    ...
    arenaKey: "analog_ic",
    color: "#84CC16",
    aliases: ["ic layout engineer","custom layout engineer","virtuoso layout engineer","mixed signal engineer","analog ic designer","full custom layout engineer"],
    ...
    auraSkills: ["Full-Custom IC Layout","Cadence Virtuoso","Device Matching Techniques","DRC / LVS / ERC","Guard Rings & Shielding","Parasitic Extraction (PEX)","ESD Protection Layout","Mixed-Signal Interface"],
...

  {
    ...
    arenaKey: "ece",
    color: "#84CC16",
    aliases: ["rf hardware engineer","antenna design engineer","microwave circuit designer","5g rf engineer","wireless hardware engineer","radio frequency engineer"],
    ...
    auraSkills: ["RF Circuit Design","Antenna Design & Simulation","S-Parameters & Smith Chart","Impedance Matching","RF Amplifiers (LNA / PA)","Filters (BPF / LPF)","ADS / HFSS / CST Tools","RF Testing (VNA / Spectrum Analyzer)","EMC/EMI Compliance"],
...

  {
    ...
    arenaKey: "ece",
    color: "#84CC16",
    aliases: ["iot developer","edge ai engineer","connected devices engineer","smart home engineer","iot firmware engineer","mqtt developer"],
    ...
    auraSkills: ["IoT Protocols (MQTT / CoAP / HTTP)","Edge Computing","Embedded C / Python","Cloud IoT Platforms (AWS IoT / Azure IoT Hub)","Sensor Interfacing","Microcontrollers (ESP32 / Arduino / Raspberry Pi)","BLE / Zigbee / LoRaWAN","Security for IoT Devices","OTA Updates","Power Management"],
...

  {
    ...
    arenaKey: "ece",
    color: "#84CC16",
    aliases: ["5g network engineer","ran engineer","lte engineer","core network engineer","telecom protocol engineer","wireless network engineer"],
    ...
    auraSkills: ["5G NR Architecture (SA/NSA)","LTE / 4G RAN","3GPP Standards","Core Network (EPC / 5GC)","Protocol Stacks (PHY/MAC/RLC/PDCP)","RF Planning & Optimization","VoLTE / VoNR","MIMO & Beamforming","Network Slicing"],
...

  {
    ...
    arenaKey: "ece",
    color: "#84CC16",
    aliases: ["pcb designer","board design engineer","schematic engineer","circuit board designer","electronics hardware engineer","hardware design engineer"],
    ...
    auraSkills: ["Schematic Design (Altium/KiCad)","PCB Layout & Routing","Signal Integrity Analysis","Power Electronics Design","Analog Circuit Design","Digital Logic Design","Component Selection & Sourcing","Board Bring-Up & Debug","EMC/EMI Testing","Hardware Testing (Oscilloscope/Logic Analyzer)"],
...

  {
    ...
    arenaKey: "eee",
    color: "#EAB308",
    aliases: ["electrical engineer","grid engineer","power distribution engineer","transmission engineer","protection engineer","smart grid engineer","substation engineer"],
...

  {
    ...
    arenaKey: "eee",
    color: "#EAB308",
    aliases: ["motor design engineer","vfd engineer","drive engineer","servo engineer","bldc engineer","ev motor engineer","electric motor engineer"],
    ...
    auraSkills: ["DC / AC Machine Analysis","Transformer Design & Testing","Induction Motor Characteristics","Variable Frequency Drives (VFD)","BLDC Motor Design","Field-Oriented Control (FOC)","Motor Testing Standards","Simulation (MATLAB/Simulink)"],
...

  {
    ...
    arenaKey: "eee",
    color: "#EAB308",
    aliases: ["plc programmer","scada developer","industrial automation engineer","process automation engineer","pid engineer","automation and control engineer"],
    ...
    auraSkills: ["Control System Theory (Transfer Functions)","PID Controller Design","Root Locus & Bode Plots","State-Space Representation","Digital Control Systems","PLC Programming (Ladder/FBD)","SCADA Design","Sensor & Actuator Integration","MATLAB/Simulink Control"],
...

  {
    ...
    arenaKey: "eee",
    color: "#EAB308",
    aliases: ["inverter engineer","ev charging engineer","battery engineer","smps design engineer","dc-dc converter engineer","ev powertrain engineer","bms engineer"],
    ...
    auraSkills: ["DC-DC Converters (Buck/Boost/Flyback)","DC-AC Inverters (Full-Bridge/H-Bridge)","Gate Driver Design","MOSFET / IGBT / SiC / GaN Devices","PWM Techniques (SPWM / SVPWM)","Battery Management Systems (BMS)","Thermal Management of Power Devices","EMI/EMC in Power Electronics","Simulation (PSIM / LTspice)"],
...

  {
    ...
    arenaKey: "eee",
    color: "#EAB308",
    aliases: ["field instrument engineer","calibration specialist","control and instrumentation engineer","ci engineer","process control engineer","instrument design engineer"],
    ...
    auraSkills: ["Sensor Types & Selection (Pressure/Flow/Temperature/Level)","Signal Conditioning & Amplifiers","4-20mA & HART Protocols","Field Instruments (Transmitters/Valves)","PLC & DCS Integration","Calibration Techniques","Safety Instrumented Systems (SIS)","Fieldbus Protocols (PROFIBUS / Foundation Fieldbus)"],
...

  {
    ...
    arenaKey: "mechanical",
    color: "#64748B",
    aliases: ["cad design engineer","product design engineer","solidworks designer","catia engineer","nx engineer","design draughtsman","mechanical product engineer"],
    ...
    auraSkills: ["CAD (SolidWorks / CATIA / NX)","GD&T (Geometric Dimensioning & Tolerancing)","Engineering Drawing Standards","FEA (ANSYS / Abaqus)","Material Selection","Mechanism Design","DFM & DFA","Prototyping & Testing","Tolerance Stack-Up Analysis","Injection Moulding Design","Sheet Metal Design"],
...

  {
    ...
    arenaKey: "mechanical",
    color: "#64748B",
    aliases: ["hvac engineer","cfd analyst","cooling engineer","thermal analysis engineer","refrigeration engineer","heat transfer engineer"],
    ...
    auraSkills: ["Heat Transfer (Conduction/Convection/Radiation)","Heat Exchangers (LMTD/NTU)","Boilers & Steam Power Plants","Refrigeration & HVAC (VCR)","CFD Simulation (ANSYS Fluent)","Combustion & Fuels","Energy Audit & Conservation","Thermal Insulation Design"],
...

  {
    ...
    arenaKey: "mechanical",
    color: "#64748B",
    aliases: ["production planning engineer","cnc programmer","lean expert","six sigma engineer","quality manufacturing engineer","tooling design engineer"],
    ...
    auraSkills: ["Manufacturing Processes (Machining/Casting/Welding)","CNC Programming (G-Code/M-Code)","Lean Manufacturing & Kaizen","Statistical Process Control (SPC)","FMEA & Control Plans","Jigs & Fixture Design","Quality Systems (ISO 9001)","CAM Software (Mastercam)"],
...

  {
    ...
    arenaKey: "mechanical",
    color: "#64748B",
    aliases: ["piping engineer","hydraulic design engineer","pump engineer","turbomachinery engineer","process piping engineer","compressor design engineer"],
    ...
    auraSkills: ["Fluid Statics & Dynamics","Bernoulli & Continuity Equations","Pipe Flow & Head Loss (Darcy-Weisbach)","Pumps & Turbines Characteristics","Boundary Layer Theory","Hydraulic Machines (Pelton/Francis/Kaplan)","CFD (ANSYS Fluent / OpenFOAM)","Hydraulic Transients (Water Hammer)"],
...

  {
    ...
    arenaKey: "civil",
    color: "#78716C",
    aliases: ["rcc designer","steel structure engineer","building engineer","bridge designer","structural design engineer","concrete design engineer"],
    ...
    auraSkills: ["Structural Analysis (Indeterminate)","RC Design (IS 456)","Steel Design (IS 800)","Pre-stressed Concrete","Finite Element Analysis (SAP2000/ETABS)","Seismic Design (IS 1893)","Foundation Design","Structural Audit & Retrofitting"],
...

  {
    ...
    arenaKey: "civil",
    color: "#78716C",
    aliases: ["soil investigation engineer","piling specialist","ground engineer","foundation design engineer","retaining wall designer"],
    ...
    auraSkills: ["Soil Classification & Index Properties","Shear Strength (Mohr-Coulomb)","Compressibility & Settlement Analysis","Foundation Types (Shallow/Deep)","Pile Design & Load Test","Slope Stability Analysis (Bishop)","Ground Improvement Techniques","Soil Testing (SPT/CPT/Plate Load)"],
...

  {
    ...
    arenaKey: "civil",
    color: "#78716C",
    aliases: ["road design engineer","traffic planning engineer","urban mobility engineer","highway design engineer","pavement design engineer"],
    ...
    auraSkills: ["Highway Geometric Design (IRC)","Pavement Design (Flexible / Rigid)","Traffic Engineering & Studies","Traffic Signal Design","Road Safety Audit","Urban Transportation Planning","AutoCAD Civil 3D"],
...

  {
    ...
    arenaKey: "civil",
    color: "#78716C",
    aliases: ["hydrologist","irrigation engineer","water supply engineer","drainage engineer","dam design engineer","flood management engineer"],
    ...
    auraSkills: ["Hydrology (Rainfall-Runoff Analysis)","Open Channel Flow","Canal Design & Lining","Dam & Spillway Design","Flood Routing & Estimation","Irrigation Systems","Water Supply Network Design","HEC-RAS / SWMM"],
...

  {
    ...
    arenaKey: "civil",
    color: "#78716C",
    aliases: ["site manager","civil supervisor","quantity estimator","project site engineer","bq engineer","construction site engineer"],
    ...
    auraSkills: ["Construction Sequence & Method Statements","Bar Bending Schedule (BBS)","Quantity Estimation & BOQ","Project Scheduling (CPM/PERT)","Construction Materials Testing","Quality Control (IS / ASTM)","Safety at Site (IS 4014)","Contract Management (FIDIC/PWD)","ERP Systems (Primavera / MS Project)"],
...

  {
    ...
    arenaKey: "civil",
    color: "#78716C",
    aliases: ["civil engineering fresher","junior civil engineer","graduate civil engineer","infrastructure graduate"],
    ...
    auraSkills: ["Structural Analysis","Soil Mechanics","Fluid Mechanics / Hydraulics","Transportation Engineering","Construction Technology","Surveying & Geomatics","Environmental Engineering","AutoCAD","Estimation & Costing"],
...

  {
    ...
    challengeKey: "ml",
    color: "#A855F7",
    aliases: ["ai developer","llm engineer","genai engineer","deep learning engineer","nlp developer","computer vision engineer","data scientist ai","mlops engineer"],
    keywords: ["machine learning","ml engineer","ai engineer","deep learning","data scientist","nlp engineer","computer vision","llm engineer","generative ai","pytorch","tensorflow","model engineer","ai ml","artificial intelligence"],
    auraSkills: ["Python (NumPy/Pandas)","Scikit-learn","PyTorch / TensorFlow","Model Evaluation (AUC/F1/RMSE)","Feature Engineering","Data Preprocessing","Neural Network Design","NLP (Transformers/BERT)","Computer Vision (CNNs)","Model Deployment (FastAPI/TorchServe)","Experiment Tracking (MLflow/W&B)","LLM Fine-Tuning / RAG"],
    assessmentSkills: ["Python","NumPy / Pandas","Scikit-learn","Model Evaluation","Feature Engineering","Neural Networks","Data Preprocessing","Statistics","Regression / Classification","Deep Learning Basics","Model Deployment","Experiment Tracking"],
    streamCategories: ["AI_ML"],
    launchpadTags: ["machine learning engineer","ai engineer","data scientist","nlp engineer","computer vision engineer","deep learning engineer"],
    pulseTopics: ["Machine Learning","Deep Learning","PyTorch","TensorFlow","NLP","LLMs","GenAI","Data Science","Computer Vision"],
    interviewFocus: ["model evaluation","feature engineering","neural network design","bias/variance","deployment pipeline"],
  },
...

  {
    ...
    stream: "IT",
    arenaKey: "android",
    challengeKey: "android",
    color: "#22C55E",
    aliases: ["kotlin engineer","mobile app developer android","android application developer","android studio developer"],
    keywords: ["android developer","android engineer","kotlin developer","android app","android sdk","jetpack compose","android studio","mobile android","android application"],
    auraSkills: ["Kotlin","Android SDK","Jetpack Compose","MVVM Architecture","Room Database","Retrofit / OkHttp","Coroutines & Flow","Push Notifications (FCM)","Play Store Deployment"],
    assessmentSkills: ["Kotlin","Java","Android SDK","Jetpack Compose","MVVM Architecture","Room Database","Retrofit","Coroutines","UI/UX Design","Testing","Push Notifications","Play Store Deployment"],
    streamCategories: [],
    launchpadTags: ["android developer","kotlin developer","android engineer","mobile developer android"],
    pulseTopics: ["Android","Kotlin","Jetpack Compose","Mobile Development","Android Studio","MVVM","Firebase"],
    interviewFocus: ["activity/fragment lifecycle","coroutines","MVVM","room database","compose state"],
  },
...

  {
    ...
    challengeKey: "ios",
    color: "#64748B",
    aliases: ["swift engineer","apple ios developer","iphone app developer","swiftui developer","mobile app developer ios","xcode engineer","ios application developer"],
    keywords: ["ios developer","swift developer","ios engineer","xcode developer","swiftui developer","apple developer","objective-c developer","ios app developer","iphone developer"],
    auraSkills: ["Swift","Xcode","SwiftUI","UIKit","Core Data","Networking (URLSession/Combine)","Auto Layout","App Store Deployment","Memory Management (ARC)"],
    assessmentSkills: ["Swift","Xcode","UIKit","SwiftUI","Core Data","Networking (URLSession)","MVC/MVVM","Auto Layout","Push Notifications","App Store Deployment","Testing (XCTest)","Memory Management"],
    streamCategories: [],
    launchpadTags: ["ios developer","swift developer","ios engineer","apple developer","mobile developer ios"],
    pulseTopics: ["iOS","Swift","SwiftUI","Xcode","Apple","Mobile Development","UIKit","Core Data"],
    interviewFocus: ["ARC memory management","SwiftUI vs UIKit","Core Data","URLSession","App Store review guidelines"],
  },
...

  {
    ...
    stream: "Pharmacy",
    arenaKey: "pharmacy",
    challengeKey: "pharmacy",
    color: "#EC4899",
    aliases: ["pharma professional","drug regulatory officer","quality assurance pharmacist","pharmaceutical analyst","pharma QA","clinical pharmacist","hospital pharmacist","pharmaceutical scientist"],
    keywords: ["pharmacist","pharmacy","pharma","pharmaceutical","drug formulation","clinical pharmacist","hospital pharmacist","community pharmacist","pharmacy technician","drug regulatory","pharmacovigilance","drug discovery"],
    auraSkills: ["Pharmaceutics (Dosage Forms)","Pharmacology (MOA & Drug Classes)","Medicinal Chemistry","Clinical Pharmacy Practice","Pharmacokinetics & Pharmacodynamics","Drug Interactions","Quality Assurance & GMP","Hospital Pharmacy Workflow","Regulatory Affairs (FDA/CDSCO)","Pharmaceutical Analysis"],
    assessmentSkills: ["Pharmaceutics","Pharmacology","Medicinal Chemistry","Drug Design & Discovery","Clinical Pharmacy","Pharmacokinetics & Pharmacodynamics","Drug Regulatory Affairs","Quality Assurance & GMP","Biopharmaceutics","Hospital & Community Pharmacy","Industrial Pharmacy","Pharmaceutical Analysis"],
    streamCategories: ["Pharmacy"],
    launchpadTags: ["pharmacist","clinical pharmacist","hospital pharmacist","pharmaceutical scientist","drug regulatory affairs specialist"],
    pulseTopics: ["Pharmacy","Pharmaceutical Sciences","Clinical Pharmacy","Drug Discovery","GMP","Regulatory Affairs","FDA","CDSCO"],
    interviewFocus: ["pharmacokinetics","drug interactions","clinical pharmacy","GMP","regulatory submissions"],
  },
...

  {
    ...
    slug: "mba-business-manager",
    stream: "MBA",
    arenaKey: "mba",
    challengeKey: "mba",
    color: "#F59E0B",
    aliases: ["mba graduate","management consultant","business development manager","operations analyst","marketing executive","finance analyst","hr executive","strategy analyst","management trainee"],
    keywords: ["mba","business manager","operations manager","hr manager","marketing manager","management trainee","business analyst mba","general manager","product manager mba","strategy consultant","brand manager","supply chain manager"],
    auraSkills: ["Business Strategy (Porter / SWOT)","Financial Analysis (P&L / Balance Sheet)","Marketing (4Ps / STP)","Operations & Supply Chain","Human Resources Management","Business Communication","Data for Decisions (Excel / SQL)","Project Management","Entrepreneurship","Stakeholder Management"],
    assessmentSkills: ["Management Principles","Financial Accounting","Marketing Management","Business Strategy","Operations Management","Human Resource Management","Business Analytics","Financial Management","Entrepreneurship","Business Law & Ethics","Supply Chain Management","Organisational Behaviour"],
    streamCategories: ["MBA"],
    launchpadTags: ["business manager","operations manager","management trainee","product manager","marketing manager","strategy analyst"],
    pulseTopics: ["Business Strategy","Marketing","Finance","Operations","MBA","Consulting","Leadership","Entrepreneurship"],
    interviewFocus: ["case study analysis","business strategy","financial modelling","marketing mix","supply chain"],
  },
]
...
// keyword + alias → role (sorted longest first so "analog layout engineer" beats "engineer")
