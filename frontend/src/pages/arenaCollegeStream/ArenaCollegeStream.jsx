...
/**
 * Professional SQL workspace layout for a Domain Role mission — problem
 * statement + workplace framing -> schema -> SQL editor -> Run Query ->
 * output panel (execution stats, real result table, deterministic insight,
 * deterministic checklist) -> ELO + Continue to next mission.
 *
 * Every number shown here is real: execution_time_ms/result/checklist come
 * straight from the server's actual sandboxed query run
 * (backend/server/lib/domainRole/sqlSandbox.js) — nothing is a fabricated
        ...
        {inDomainBranch && (
          <>
            ...
            {/* Workspace tab = the current/next task with its timer only — no
                ...
                DomainMissionWorkspace after a pass; that's a non-blocking
