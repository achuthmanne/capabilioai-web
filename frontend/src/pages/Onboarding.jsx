...
function ResultModal({ result, keyword, questions, onGoToDashboard, savingResult, saveError }) {
  ...
  return (
    <div style={{ position:"fixed",inset:0,zIndex:9999,background: `#F9FAFB url("data:image/svg+xml;utf8,%3Csvg%20width%3D%22400%22%20height%3D%22200%22%20xmlns%3D%22http%3A//www.w3.org/2000/svg%22%3E%0A%20%20%3C%21--%20Row%201%20--%3E%0A%20%20%3Ctext%20x%3D%22100%22%20y%3D%2280%22%20font-family%3D%22ui-serif%2C%20Georgia%2C%20Cambria%2C%20%27Times%20New%20Roman%27%2C%20Times%2C%20serif%22%20font-weight%3D%22800%22%20font-size%3D%2226%22%20text-anchor%3D%22middle%22%20letter-spacing%3D%22-0.02em%22%3E%0A%20%20%20%20%3Ctspan%20fill%3D%22rgba%2817%2C24%2C39%2C0.08%29%22%3ECapabilio%20%3C/tspan%3E%0A%20%20%20%20%3Ctspan%20fill%3D%22rgba%28249%2C115%2C22%2C0.14%29%22%3EAI%3C/tspan%3E%0A%20%20%3C/text%3E%0A%20%20%3C%21--%20Row%202%20%28offset%29%20--%3E%0A%20%20%3Ctext%20x%3D%22300%22%20y%3D%22180%22%20font-family%3D%22ui-serif%2C%20Georgia%2C%20Cambria%2C%20%27Times%20New%20Roman%27%2C%20Times%2C%20serif%22%20font-weight%3D%22800%22%20font-size%3D%2226%22%20text-anchor%3D%22middle%22%20letter-spacing%3D%22-0.02em%22%3E%0A%20%20%20%20%3Ctspan%20fill%3D%22rgba%2817%2C24%2C39%2C0.08%29%22%3ECapabilio%20%3C/tspan%3E%0A%20%20%20%20%3Ctspan%20fill%3D%22rgba%28249%2C115%2C22%2C0.14%29%22%3EAI%3C/tspan%3E%0A%20%20%3C/text%3E%0A%3C/svg%3E") repeat`,display:"flex",alignItems:"center",justifyContent:"center",opacity:vis?1:0,transition:"opacity 0.3s",padding:16, fontFamily: '"Inter", "DM Sans", sans-serif' }}>
      <div style={{ width:"100%",maxWidth:760,background:"#FFFFFF",border:"1px solid #E5E7EB",borderRadius:24,height:"90vh",maxHeight:800,display:"flex",flexDirection:"column",boxShadow:"none",transform:vis?"translateY(0) scale(1)":"translateY(20px) scale(0.97)",transition:"all 0.4s cubic-bezier(0.16, 1, 0.3, 1)",overflow:"hidden" }}>
        ...
        {/* Flat Tabs */}
          ...
          {TABS.map(t => (
            <button key={t.id} onClick={()=>setTab(t.id)} style={{ padding:"8px 16px",borderRadius:999,fontSize:14,fontWeight:600,background:tab===t.id?"#FFFFFF":"transparent",color:tab===t.id?"#111827":"#6B7280",border:tab===t.id?"1px solid #E5E7EB":"1px solid transparent",boxShadow:"none",cursor:"pointer",transition:"all 0.2s",whiteSpace:"nowrap" }}>
              {t.label}
            </button>
          ))}
        </div>
...
function ProfessionalResultModal({ auraResult, onGoToDashboard, savingResult }) {
  ...
  return (
    <div style={{ position:"fixed",inset:0,zIndex:9999,background:"rgba(255,255,255,0.97)",backdropFilter:"blur(20px)",display:"flex",alignItems:"center",justifyContent:"center",opacity:vis?1:0,transition:"opacity 0.35s",padding:16 }}>
      <div style={{ width:"100%",maxWidth:620,background:T.surface,border:`1px solid ${T.green}25`,borderRadius:24,height:"90vh",display:"flex",flexDirection:"column",boxShadow:"none",transform:vis?"scale(1)":"scale(0.94)",transition:"transform 0.45s cubic-bezier(0.34,1.56,0.64,1)",overflow:"hidden" }}>
...
const LoadingCountdown = ({ path }) => {
  ...
  return (
      <div style={{ display: "flex", flexDirection: "column", width: "100%", minHeight: "100vh", background: "#FFFFFF", fontFamily: '"Inter", "DM Sans", sans-serif' }}>
        ...
        <style>{`
          @keyframes ob-hype-num {
            0%   { transform: translateX(-160px) scale(0.6); opacity: 0; color: #F3F4F6; }
            20%  { transform: translateX(0px) scale(1); opacity: 1; color: ${pt.accent}; }
            70%  { transform: translateX(0px) scale(1); opacity: 1; color: ${pt.accent}; }
            100% { transform: translateX(160px) scale(0.6); opacity: 0; color: #F3F4F6; }
          }
          @keyframes ob-hype-text {
        ...
        <div style={{ flex: 1, display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", padding: "0 24px 120px" }}>
          <div style={{ display: "flex", flexDirection: "column", alignItems: "center", maxWidth: 640, width: "100%", textAlign: "center" }}>
            ...
            <div style={{ position: "relative", width: "100%", height: 200 }}>
               <div className="hype-abs"><div style={{ fontSize: 140, animation: "ob-hype-num 3s cubic-bezier(0.25, 1, 0.5, 1) both", animationDelay: "0s" }}>3</div></div>
               <div className="hype-abs"><div style={{ fontSize: 140, animation: "ob-hype-num 3s cubic-bezier(0.25, 1, 0.5, 1) both", animationDelay: "2.2s" }}>2</div></div>
               <div className="hype-abs"><div style={{ fontSize: 140, animation: "ob-hype-num 3s cubic-bezier(0.25, 1, 0.5, 1) both", animationDelay: "4.4s" }}>1</div></div>
               <div className="hype-abs"><div style={{ fontSize: 96, animation: "ob-hype-text 1s cubic-bezier(0.16, 1, 0.3, 1) both", animationDelay: "6.6s", whiteSpace: "nowrap" }}>
                  <span style={{ color: pt.accent }}>Let's go</span>
...
export default function Onboarding({ user, onComplete, onBack }) {
  ...
  if (step === "plan") {
    ...
    return (
      <div style={{ minHeight:"100vh", background:T.pageBg, color:T.text, fontFamily:T.body }}>
        ...
        <nav style={{ padding: "32px 40px", display: "flex", justifyContent: "space-between", alignItems: "center", position: "sticky", top: 0, zIndex: 50, background: "#FFFFFF" }}>
          <span style={{ fontSize: 24, fontFamily: 'ui-serif, Georgia, Cambria, "Times New Roman", Times, serif', fontWeight: 800, letterSpacing: "-0.02em", color: "#14161A" }}>Capabilio <span style={{ color: getPathTheme(path || "student").accent }}>AI</span></span>
  ...
  // ══ SCREEN: QUIZ ═══════════════════════════════════════════════════
    ...
    return (
      <div 
        onCopy={(e) => { if (!showResultModal) e.preventDefault() }}
          onCut={(e) => { if (!showResultModal) e.preventDefault() }}
          onPaste={(e) => { if (!showResultModal) e.preventDefault() }}
          onContextMenu={(e) => { if (!showResultModal) e.preventDefault() }}
          style={{ userSelect: showResultModal ? "auto" : "none", display: "flex", flexDirection: "column", width: "100%", height: "100vh", background: `#F9FAFB url("data:image/svg+xml;utf8,%3Csvg%20width%3D%22400%22%20height%3D%22200%22%20xmlns%3D%22http%3A//www.w3.org/2000/svg%22%3E%0A%20%20%3C%21--%20Row%201%20--%3E%0A%20%20%3Ctext%20x%3D%22100%22%20y%3D%2280%22%20font-family%3D%22ui-serif%2C%20Georgia%2C%20Cambria%2C%20%27Times%20New%20Roman%27%2C%20Times%2C%20serif%22%20font-weight%3D%22800%22%20font-size%3D%2226%22%20text-anchor%3D%22middle%22%20letter-spacing%3D%22-0.02em%22%3E%0A%20%20%20%20%3Ctspan%20fill%3D%22rgba%2817%2C24%2C39%2C0.08%29%22%3ECapabilio%20%3C/tspan%3E%0A%20%20%20%20%3Ctspan%20fill%3D%22rgba%28249%2C115%2C22%2C0.14%29%22%3EAI%3C/tspan%3E%0A%20%20%3C/text%3E%0A%20%20%3C%21--%20Row%202%20%28offset%29%20--%3E%0A%20%20%3Ctext%20x%3D%22300%22%20y%3D%22180%22%20font-family%3D%22ui-serif%2C%20Georgia%2C%20Cambria%2C%20%27Times%20New%20Roman%27%2C%20Times%2C%20serif%22%20font-weight%3D%22800%22%20font-size%3D%2226%22%20text-anchor%3D%22middle%22%20letter-spacing%3D%22-0.02em%22%3E%0A%20%20%20%20%3Ctspan%20fill%3D%22rgba%2817%2C24%2C39%2C0.08%29%22%3ECapabilio%20%3C/tspan%3E%0A%20%20%20%20%3Ctspan%20fill%3D%22rgba%28249%2C115%2C22%2C0.14%29%22%3EAI%3C/tspan%3E%0A%20%20%3C/text%3E%0A%3C/svg%3E") repeat`, fontFamily: '"Inter", "DM Sans", sans-serif', padding: "40px 24px", overflow: "hidden" }}
      >
        <style>{`
          @media print {
