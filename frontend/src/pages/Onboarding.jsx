  ...
  // ══ SCREEN: QUIZ ═══════════════════════════════════════════════════
    ...
    return (
      <div 
        ...
        style={{ userSelect: "none", display: "flex", flexDirection: "column", width: "100%", height: "100vh", background: `#F9FAFB url("data:image/svg+xml;utf8,%3Csvg%20width%3D%22340%22%20height%3D%22220%22%20xmlns%3D%22http%3A//www.w3.org/2000/svg%22%3E%0A%20%20%3Cg%20transform%3D%22rotate%28-25%20170%20110%29%22%3E%0A%20%20%20%20%3Ctext%20x%3D%22170%22%20y%3D%22110%22%20font-family%3D%22system-ui%2C%20-apple-system%2C%20Inter%2C%20sans-serif%22%20font-weight%3D%22800%22%20font-size%3D%2228%22%20text-anchor%3D%22middle%22%20letter-spacing%3D%22-0.02em%22%3E%0A%20%20%20%20%20%20%3Ctspan%20fill%3D%22rgba%2817%2C24%2C39%2C0.035%29%22%3ECapabilio%20%3C/tspan%3E%0A%20%20%20%20%20%20%3Ctspan%20fill%3D%22rgba%28249%2C115%2C22%2C0.05%29%22%3EAI%3C/tspan%3E%0A%20%20%20%20%3C/text%3E%0A%20%20%3C/g%3E%0A%3C/svg%3E") repeat`, fontFamily: '"Inter", "DM Sans", sans-serif', padding: "40px 24px", overflow: "hidden" }}
      >
        <style>{`
          @media print {
