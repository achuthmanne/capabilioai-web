...
import {
  ...
  ECE_TELECOM_CHALLENGES, ECE_CIRCUIT_CHALLENGES, ECE_INTERACTIVE_CHALLENGES,
  ...
  MECH_CHALLENGES, MECH_THERMAL_CHALLENGES, MECH_FLUID_CHALLENGES,
  MECH_DESIGN_CHALLENGES, MECH_MFG_CHALLENGES, MECH_HVAC_CHALLENGES,
  ML_CHALLENGES, DATA_ANALYST_CHALLENGES, MBA_CHALLENGES, PHARMACY_CHALLENGES,
  ML_NEURAL_NETS_CHALLENGES, ML_NLP_CHALLENGES, ML_CV_CHALLENGES,
  ML_UNSUPERVISED_CHALLENGES, ML_DEPLOYMENT_CHALLENGES,
  MBA_MARKETING_CHALLENGES, MBA_OPERATIONS_CHALLENGES, MBA_ACCOUNTING_CHALLENGES,
  MBA_HR_CHALLENGES, MBA_ANALYTICS_CHALLENGES,
  PHARMACY_PHARMACOLOGY_CHALLENGES, PHARMACY_CHEMISTRY_CHALLENGES,
  PHARMACY_CLINICAL_CHALLENGES, PHARMACY_REGULATORY_CHALLENGES, PHARMACY_HOSPITAL_CHALLENGES,
  DATA_ANALYST_ADVANCED_SQL_CHALLENGES, DATA_ANALYST_ETL_CHALLENGES, DATA_ANALYST_STATS_CHALLENGES,
  DATA_ANALYST_EXPERIMENTATION_CHALLENGES, DATA_ANALYST_STORYTELLING_CHALLENGES,
  DATA_ANALYST_FORECASTING_CHALLENGES, DATA_ANALYST_DATA_MODELING_CHALLENGES,
  DATA_ANALYST_METRICS_CHALLENGES, DATA_ANALYST_AUTOMATION_CHALLENGES, DATA_ANALYST_GOVERNANCE_CHALLENGES,
  IOT_EMBEDDED_PROGRAMMING_CHALLENGES, IOT_SENSOR_DATA_CHALLENGES, IOT_CONNECTIVITY_CHALLENGES,
  IOT_SECURITY_CHALLENGES, IOT_EDGE_COMPUTING_CHALLENGES,
  ML_REINFORCEMENT_LEARNING_CHALLENGES, ML_MODEL_EVALUATION_CHALLENGES,
  ML_FEATURE_ENGINEERING_CHALLENGES, ML_EXPLAINABILITY_CHALLENGES,
  ML_EXPERIMENT_TRACKING_CHALLENGES,
  MBA_FINANCE_CHALLENGES, MBA_STRATEGY_CHALLENGES, MBA_SUPPLY_CHAIN_CHALLENGES,
  MBA_NEGOTIATION_CHALLENGES, MBA_LEADERSHIP_CHALLENGES,
  PHARMACY_PHARMACOKINETICS_CHALLENGES, PHARMACY_TOXICOLOGY_CHALLENGES,
  PHARMACY_COMPOUNDING_CHALLENGES, PHARMACY_COMMUNITY_CHALLENGES,
  PHARMACY_INFORMATICS_CHALLENGES,
  EEE_RENEWABLE_CHALLENGES, EEE_SAFETY_CHALLENGES, EEE_DRIVES_CHALLENGES,
  EEE_PROTECTION_CHALLENGES, EEE_SMARTGRID_CHALLENGES,
  CIVIL_SURVEY_CHALLENGES, CIVIL_ENVIRONMENTAL_CHALLENGES, CIVIL_SEISMIC_CHALLENGES,
  CIVIL_STEEL_CHALLENGES, CIVIL_ESTIMATING_CHALLENGES,
  MECH_VIBRATIONS_CHALLENGES, MECH_ROBOTICS_CHALLENGES, MECH_AUTOMOTIVE_CHALLENGES,
  MECH_FEA_CHALLENGES, MECH_AUTOMATION_CHALLENGES,
  ECE_ANTENNA_CHALLENGES, ECE_SENSORS_CHALLENGES, ECE_PHOTONICS_CHALLENGES,
  ECE_MICROCONTROLLER_CHALLENGES, ECE_ANALOG_CHALLENGES, ECE_PCB_CHALLENGES,
  ECE_DSP_CHALLENGES,
} from "../config/domainChallenges"

// Map stream category → local challenge arrays
//
// 2026-08-10: ECE_INTERACTIVE_CHALLENGES / MECH_FLUID/DESIGN/MFG/HVAC_
// CHALLENGES / ML_CHALLENGES / DATA_ANALYST_CHALLENGES / MBA_CHALLENGES /
// PHARMACY_CHALLENGES were all already fully written in domainChallenges.js
// but never wired in here -- NON_IT_STREAM_CATS (below) already listed
// "Pharmacy", "MBA", "AI_DS", "AI_ML" as recognized streams, but with no
// matching key in this map, students on those streams saw a completely
// empty Common Challenges page (Arena.jsx's AI_ML/AI_DS cards even promise
// "15 problems" while delivering zero). MECH went from 8 wired challenges
// to the full 24 already authored; ECE from 27 to 30.
//
// 2026-08-10 (cont'd): added 60 newly-authored challenges (20 each for
// AI/ML, MBA, Pharmacy, 5 sub-topic arrays x4) to deepen those three
// streams to parity with ECE/Civil (~24-30 each).
const LOCAL_ENG_BANK = {
  ...
  Civil:      [...CIVIL_CHALLENGES, ...CIVIL_STRUCTURAL_CHALLENGES, ...CIVIL_GEO_CHALLENGES,
                ...
                ...CIVIL_SURVEY_CHALLENGES, ...CIVIL_ENVIRONMENTAL_CHALLENGES, ...CIVIL_SEISMIC_CHALLENGES,
                ...CIVIL_STEEL_CHALLENGES, ...CIVIL_ESTIMATING_CHALLENGES],
  Mechanical: [...MECH_CHALLENGES, ...MECH_THERMAL_CHALLENGES, ...MECH_FLUID_CHALLENGES,
                ...MECH_DESIGN_CHALLENGES, ...MECH_MFG_CHALLENGES, ...MECH_HVAC_CHALLENGES,
                ...MECH_VIBRATIONS_CHALLENGES, ...MECH_ROBOTICS_CHALLENGES, ...MECH_AUTOMOTIVE_CHALLENGES,
                ...MECH_FEA_CHALLENGES, ...MECH_AUTOMATION_CHALLENGES],
  IoT:        [...ECE_IOT_CHALLENGES, ...ECE_CIRCUIT_CHALLENGES,
                ...IOT_EMBEDDED_PROGRAMMING_CHALLENGES, ...IOT_SENSOR_DATA_CHALLENGES,
                ...IOT_CONNECTIVITY_CHALLENGES, ...IOT_SECURITY_CHALLENGES, ...IOT_EDGE_COMPUTING_CHALLENGES],
  AI_ML:      [...ML_CHALLENGES, ...ML_NEURAL_NETS_CHALLENGES, ...ML_NLP_CHALLENGES,
                ...ML_CV_CHALLENGES, ...ML_UNSUPERVISED_CHALLENGES, ...ML_DEPLOYMENT_CHALLENGES,
                ...ML_REINFORCEMENT_LEARNING_CHALLENGES, ...ML_MODEL_EVALUATION_CHALLENGES,
                ...ML_FEATURE_ENGINEERING_CHALLENGES, ...ML_EXPLAINABILITY_CHALLENGES,
                ...ML_EXPERIMENT_TRACKING_CHALLENGES],
  MBA:        [...MBA_CHALLENGES, ...MBA_MARKETING_CHALLENGES, ...MBA_OPERATIONS_CHALLENGES,
                ...MBA_ACCOUNTING_CHALLENGES, ...MBA_HR_CHALLENGES, ...MBA_ANALYTICS_CHALLENGES,
                ...MBA_FINANCE_CHALLENGES, ...MBA_STRATEGY_CHALLENGES, ...MBA_SUPPLY_CHAIN_CHALLENGES,
                ...MBA_NEGOTIATION_CHALLENGES, ...MBA_LEADERSHIP_CHALLENGES],
  AI_DS:      [...DATA_ANALYST_CHALLENGES, ...DATA_ANALYST_ADVANCED_SQL_CHALLENGES, ...DATA_ANALYST_ETL_CHALLENGES,
                ...DATA_ANALYST_STATS_CHALLENGES, ...DATA_ANALYST_EXPERIMENTATION_CHALLENGES, ...DATA_ANALYST_STORYTELLING_CHALLENGES,
                ...DATA_ANALYST_FORECASTING_CHALLENGES, ...DATA_ANALYST_DATA_MODELING_CHALLENGES,
                ...DATA_ANALYST_METRICS_CHALLENGES, ...DATA_ANALYST_AUTOMATION_CHALLENGES, ...DATA_ANALYST_GOVERNANCE_CHALLENGES],
  Pharmacy:   [...PHARMACY_CHALLENGES, ...PHARMACY_PHARMACOLOGY_CHALLENGES, ...PHARMACY_CHEMISTRY_CHALLENGES,
                ...PHARMACY_CLINICAL_CHALLENGES, ...PHARMACY_REGULATORY_CHALLENGES, ...PHARMACY_HOSPITAL_CHALLENGES,
                ...PHARMACY_PHARMACOKINETICS_CHALLENGES, ...PHARMACY_TOXICOLOGY_CHALLENGES,
                ...PHARMACY_COMPOUNDING_CHALLENGES, ...PHARMACY_COMMUNITY_CHALLENGES,
                ...PHARMACY_INFORMATICS_CHALLENGES],
