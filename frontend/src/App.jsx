      ...
      <header style={{
          ...
          <div ref={profileMenuRef} style={{ position: "relative" }}>
            <button
              ...
              {/* Corporate-Level Google Style Profile Dropdown */}
              <AnimatePresence>
              {profileMenuOpen && (
                <motion.div
                  ...
                  style={{
                    ...
                    boxShadow: "0 4px 6px -2px rgba(0,0,0,0.05), 0 10px 15px -3px rgba(0,0,0,0.1), 0 0 0 1px rgba(0,0,0,0.02)",
                ...
                >
                  ...
                  <div style={{ padding: "16px 12px", display: "flex", alignItems: "center", gap: 16, marginBottom: 4 }}>
                    ...
                    <div style={{ display: "flex", flexDirection: "column", gap: 2, overflow: "hidden" }}>
                      ...
                      <div style={{ fontSize: 13, fontWeight: 400, color: "#5F6368", fontFamily: '"Inter", sans-serif', textOverflow: "ellipsis", overflow: "hidden", whiteSpace: "nowrap" }}>
                        {user?.email}
                      </div>
                    </div>
                  </div>
                  ...
                  <button
                    ...
                    style={{
                      ...
                      padding: "12px 14px", border: "none", background: "transparent", borderRadius: 8,
                  ...
                  <button
                    ...
                    style={{
                      ...
                      padding: "12px 14px", border: "none", background: "transparent", borderRadius: 8,
                      cursor: "pointer", fontFamily: '"Inter", sans-serif',
                      fontSize: 14, fontWeight: 500, color: "#D93025",
                      textAlign: "left", transition: "all 0.1s ease",
                    }}
                    onMouseEnter={e => { e.currentTarget.style.background = "#FCE8E6" }}
                    onMouseLeave={e => { e.currentTarget.style.background = "transparent" }}
                  >
                    <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.2" strokeLinecap="round" strokeLinejoin="round"><path d="M9 21H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h4"/><polyline points="16 17 21 12 16 7"/><line x1="21" x2="9" y1="12" y2="12"/></svg>
                    Sign out
                  </button>
                </motion.div>
              )}
